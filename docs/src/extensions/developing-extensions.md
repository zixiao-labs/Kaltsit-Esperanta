...
Use the latest version of the [`zed_extension_api`](https://crates.io/crates/zed_extension_api) available on crates.io. Make sure it's still [compatible with Zed versions](https://github.com/zixiao-labs/Kaltsit-Esperanta/blob/main/crates/extension_api#compatible-zed-versions) you want to support.
