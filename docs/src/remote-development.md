...
If you'd like to maintain the server binary yourself you can. You can either download our prebuilt versions from [GitHub](https://github.com/zixiao-labs/Kaltsit-Esperanta/releases), or [build your own](https://zed.dev/docs/development):
