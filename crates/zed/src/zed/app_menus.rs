...
pub fn app_menus(cx: &mut App) -> Vec<Menu> {
    ...
    vec![
        Menu {
            ...
            disabled: false,
            items: vec![
                MenuItem::action("About ZetaCode", zed_actions::About),
                ...
                MenuItem::action("Install Browser Runtime", browser_ui::InstallBrowserRuntime),
                MenuItem::separator(),
                #[cfg(target_os = "macos")]
                ...
                MenuItem::separator(),
                MenuItem::action("Quit ZetaCode", Quit),
            ],
        },
        Menu {
            name: "File".into(),
