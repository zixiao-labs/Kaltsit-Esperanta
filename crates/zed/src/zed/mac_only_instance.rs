...
fn instance_handshake() -> &'static str {
    match *release_channel::RELEASE_CHANNEL {
        ReleaseChannel::Dev => "Esperanta Editor Dev Instance Running",
        ReleaseChannel::Nightly => "Esperanta Editor Nightly Instance Running",
        ReleaseChannel::Preview => "Esperanta Editor Preview Instance Running",
        ReleaseChannel::Stable => "Esperanta Editor Stable Instance Running",
    }
}
