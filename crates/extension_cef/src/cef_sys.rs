...
impl Default for _cef_string_wide_t {
    fn default() -> Self {
...
pub const cef_content_setting_types_t_CEF_CONTENT_SETTING_TYPE_TPCD_TRIAL:
...
pub const cef_content_setting_types_t_CEF_CONTENT_SETTING_TYPE_TOP_LEVEL_TPCD_TRIAL:
    cef_content_setting_types_t = 92;
...
pub const cef_content_setting_types_t_CEF_CONTENT_SETTING_TOP_LEVEL_TPCD_ORIGIN_TRIAL:
...
pub const cef_content_setting_types_t_CEF_CONTENT_SETTING_TYPE_AUTO_PICTURE_IN_PICTURE:
    cef_content_setting_types_t = 94;
...
pub const cef_content_setting_types_t_CEF_CONTENT_SETTING_TYPE_FILE_SYSTEM_ACCESS_EXTENDED_PERMISSION : cef_content_setting_types_t = 95 ;
#[doc = " Whether the FSA Persistent Permissions restore prompt is eligible to be\n shown to the user, for a given origin."]
pub const cef_content_setting_types_t_CEF_CONTENT_SETTING_TYPE_FILE_SYSTEM_ACCESS_RESTORE_PERMISSION : cef_content_setting_types_t = 96 ;
#[doc = " Whether an application capturing another tab, may scroll and zoom\n the captured tab."]
pub const cef_content_setting_types_t_CEF_CONTENT_SETTING_TYPE_CAPTURED_SURFACE_CONTROL:
    cef_content_setting_types_t = 97;
...
pub const cef_content_setting_types_t_CEF_CONTENT_SETTING_TYPE_SMART_CARD_GUARD:
    cef_content_setting_types_t = 98;
#[doc = " Content setting for access to smart card readers.\n The \"guard\" content setting stores whether to allow sites to access the\n Smart Card API."]
pub const cef_content_setting_types_t_CEF_CONTENT_SETTING_TYPE_SMART_CARD_DATA:
    cef_content_setting_types_t = 99;
#[doc = " Content settings for access to printers for the Web Printing API."]
pub const cef_content_setting_types_t_CEF_CONTENT_SETTING_TYPE_WEB_PRINTING:
    cef_content_setting_types_t = 100;
...
pub const cef_content_setting_types_t_CEF_CONTENT_SETTING_TYPE_AUTOMATIC_FULLSCREEN:
    cef_content_setting_types_t = 101;
...
pub const cef_content_setting_types_t_CEF_CONTENT_SETTING_TYPE_SPEAKER_SELECTION:
    cef_content_setting_types_t = 103;
#[doc = " Content settings for access to the Direct Sockets API."]
pub const cef_content_setting_types_t_CEF_CONTENT_SETTING_TYPE_DIRECT_SOCKETS:
    cef_content_setting_types_t = 104;
#[doc = " Keyboard Lock API allows a site to capture keyboard inputs that would\n otherwise be handled by the OS or the browser."]
pub const cef_content_setting_types_t_CEF_CONTENT_SETTING_TYPE_KEYBOARD_LOCK:
    cef_content_setting_types_t = 105;
#[doc = " Pointer Lock API allows a site to hide the cursor and have exclusive\n access to mouse inputs."]
pub const cef_content_setting_types_t_CEF_CONTENT_SETTING_TYPE_POINTER_LOCK:
    cef_content_setting_types_t = 106;
...
pub const cef_content_setting_types_t_CEF_CONTENT_SETTING_TYPE_REVOKED_ABUSIVE_NOTIFICATION_PERMISSIONS : cef_content_setting_types_t = 107 ;
...
pub const cef_content_setting_types_t_CEF_CONTENT_SETTING_TYPE_TRACKING_PROTECTION:
    cef_content_setting_types_t = 108;
...
pub const cef_content_setting_types_t_CEF_CONTENT_SETTING_TYPE_DISPLAY_MEDIA_SYSTEM_AUDIO:
    cef_content_setting_types_t = 109;
#[doc = " Whether to use the higher-tier v8 optimizers for running JavaScript on the\n page."]
pub const cef_content_setting_types_t_CEF_CONTENT_SETTING_TYPE_JAVASCRIPT_OPTIMIZER:
    cef_content_setting_types_t = 110;
...
pub const cef_content_setting_types_t_CEF_CONTENT_SETTING_TYPE_STORAGE_ACCESS_HEADER_ORIGIN_TRIAL : cef_content_setting_types_t = 111 ;
#[doc = " Whether or not sites can request Hand Tracking data within WebXR Sessions."]
pub const cef_content_setting_types_t_CEF_CONTENT_SETTING_TYPE_HAND_TRACKING:
    cef_content_setting_types_t = 112;
#[doc = " Website setting to indicate whether user has opted in to allow web apps to\n install other web apps."]
pub const cef_content_setting_types_t_CEF_CONTENT_SETTING_TYPE_WEB_APP_INSTALLATION:
    cef_content_setting_types_t = 113;
#[doc = " Content settings for private network access in the context of the\n Direct Sockets API."]
pub const cef_content_setting_types_t_CEF_CONTENT_SETTING_TYPE_DIRECT_SOCKETS_PRIVATE_NETWORK_ACCESS : cef_content_setting_types_t = 114 ;
...
pub const cef_runtime_style_t_CEF_RUNTIME_STYLE_DEFAULT: cef_runtime_style_t = 0;
#[doc = "\n Use Chrome style.\n"]
pub const cef_runtime_style_t_CEF_RUNTIME_STYLE_CHROME: cef_runtime_style_t = 1;
#[doc = "\n Use Alloy style.\n"]
pub const cef_runtime_style_t_CEF_RUNTIME_STYLE_ALLOY: cef_runtime_style_t = 2;
...
pub type cef_runtime_style_t = ::std::os::raw::c_uint;
...
impl Default for _cef_accelerated_paint_info_t {
    fn default() -> Self {
        let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
        unsafe {
            ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
...
impl Default for _cef_urlparts_t {
    fn default() -> Self {
        let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
        unsafe {
            ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
...
pub const cef_termination_status_t_TS_LAUNCH_FAILED: cef_termination_status_t = 4;
#[doc = "\n On Windows, the OS terminated the process due to code integrity failure.\n"]
pub const cef_termination_status_t_TS_INTEGRITY_FAILURE: cef_termination_status_t = 5;
...
pub const cef_resultcode_t_CEF_RESULT_CODE_NORMAL_EXIT: cef_resultcode_t = 0;
#[doc = " Process was killed by user or system."]
pub const cef_resultcode_t_CEF_RESULT_CODE_KILLED: cef_resultcode_t = 1;
#[doc = " Process hung."]
pub const cef_resultcode_t_CEF_RESULT_CODE_HUNG: cef_resultcode_t = 2;
#[doc = " A bad message caused the process termination."]
pub const cef_resultcode_t_CEF_RESULT_CODE_KILLED_BAD_MESSAGE: cef_resultcode_t = 3;
#[doc = " The GPU process exited because initialization failed."]
pub const cef_resultcode_t_CEF_RESULT_CODE_GPU_DEAD_ON_ARRIVAL: cef_resultcode_t = 4;
#[doc = " The GPU process exited because initialization failed."]
pub const cef_resultcode_t_CEF_RESULT_CODE_CHROME_FIRST: cef_resultcode_t = 5;
#[doc = " A critical chrome file is missing."]
pub const cef_resultcode_t_CEF_RESULT_CODE_MISSING_DATA: cef_resultcode_t = 7;
#[doc = " Command line parameter is not supported."]
pub const cef_resultcode_t_CEF_RESULT_CODE_UNSUPPORTED_PARAM: cef_resultcode_t = 13;
#[doc = " The profile was in use on another host."]
pub const cef_resultcode_t_CEF_RESULT_CODE_PROFILE_IN_USE: cef_resultcode_t = 21;
#[doc = " Failed to pack an extension via the command line."]
pub const cef_resultcode_t_CEF_RESULT_CODE_PACK_EXTENSION_ERROR: cef_resultcode_t = 22;
#[doc = " The browser process exited early by passing the command line to another\n running browser."]
pub const cef_resultcode_t_CEF_RESULT_CODE_NORMAL_EXIT_PROCESS_NOTIFIED: cef_resultcode_t = 24;
#[doc = " A browser process was sandboxed. This should never happen."]
pub const cef_resultcode_t_CEF_RESULT_CODE_INVALID_SANDBOX_STATE: cef_resultcode_t = 31;
#[doc = " Cloud policy enrollment failed or was given up by user."]
pub const cef_resultcode_t_CEF_RESULT_CODE_CLOUD_POLICY_ENROLLMENT_FAILED: cef_resultcode_t = 32;
#[doc = " The GPU process was terminated due to context lost."]
pub const cef_resultcode_t_CEF_RESULT_CODE_GPU_EXIT_ON_CONTEXT_LOST: cef_resultcode_t = 34;
#[doc = " An early startup command was executed and the browser must exit."]
pub const cef_resultcode_t_CEF_RESULT_CODE_NORMAL_EXIT_PACK_EXTENSION_SUCCESS: cef_resultcode_t =
    36;
#[doc = " The browser process exited because system resources are exhausted. The\n system state can't be recovered and will be unstable."]
pub const cef_resultcode_t_CEF_RESULT_CODE_SYSTEM_RESOURCE_EXHAUSTED: cef_resultcode_t = 37;
#[doc = " The browser process exited because system resources are exhausted. The\n system state can't be recovered and will be unstable."]
pub const cef_resultcode_t_CEF_RESULT_CODE_CHROME_LAST: cef_resultcode_t = 38;
#[doc = " The browser process exited because system resources are exhausted. The\n system state can't be recovered and will be unstable."]
pub const cef_resultcode_t_CEF_RESULT_CODE_SANDBOX_FATAL_FIRST: cef_resultcode_t = 7006;
#[doc = " Windows sandbox could not set the integrity level."]
pub const cef_resultcode_t_CEF_RESULT_CODE_SANDBOX_FATAL_INTEGRITY: cef_resultcode_t = 7006;
#[doc = " Windows sandbox could not lower the token."]
pub const cef_resultcode_t_CEF_RESULT_CODE_SANDBOX_FATAL_DROPTOKEN: cef_resultcode_t = 7007;
#[doc = " Windows sandbox failed to flush registry handles."]
pub const cef_resultcode_t_CEF_RESULT_CODE_SANDBOX_FATAL_FLUSHANDLES: cef_resultcode_t = 7008;
#[doc = " Windows sandbox failed to forbid HCKU caching."]
pub const cef_resultcode_t_CEF_RESULT_CODE_SANDBOX_FATAL_CACHEDISABLE: cef_resultcode_t = 7009;
#[doc = " Windows sandbox failed to close pending handles."]
pub const cef_resultcode_t_CEF_RESULT_CODE_SANDBOX_FATAL_CLOSEHANDLES: cef_resultcode_t = 7010;
#[doc = " Windows sandbox could not set the mitigation policy."]
pub const cef_resultcode_t_CEF_RESULT_CODE_SANDBOX_FATAL_MITIGATION: cef_resultcode_t = 7011;
#[doc = " Windows sandbox exceeded the job memory limit."]
pub const cef_resultcode_t_CEF_RESULT_CODE_SANDBOX_FATAL_MEMORY_EXCEEDED: cef_resultcode_t = 7012;
#[doc = " Windows sandbox failed to warmup."]
pub const cef_resultcode_t_CEF_RESULT_CODE_SANDBOX_FATAL_WARMUP: cef_resultcode_t = 7013;
#[doc = " Windows sandbox failed to warmup."]
pub const cef_resultcode_t_CEF_RESULT_CODE_SANDBOX_FATAL_BROKER_SHUTDOWN_HUNG: cef_resultcode_t =
    7014;
#[doc = " Windows sandbox failed to warmup."]
pub const cef_resultcode_t_CEF_RESULT_CODE_SANDBOX_FATAL_LAST: cef_resultcode_t = 7015;
...
pub type cef_resultcode_t = ::std::os::raw::c_uint;
...
impl Default for _cef_linux_window_properties_t {
    fn default() -> Self {
        let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
        unsafe {
            ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
...
pub const cef_menu_id_t_MENU_ID_PASTE_MATCH_STYLE: cef_menu_id_t = 115;
pub const cef_menu_id_t_MENU_ID_DELETE: cef_menu_id_t = 116;
pub const cef_menu_id_t_MENU_ID_SELECT_ALL: cef_menu_id_t = 117;
...
pub const cef_dom_form_control_type_t_DOM_FORM_CONTROL_TYPE_BUTTON_POPOVER:
...
pub const cef_axis_alignment_t_CEF_AXIS_ALIGNMENT_START: cef_axis_alignment_t = 0;
#[doc = " Child views will be center-aligned."]
pub const cef_axis_alignment_t_CEF_AXIS_ALIGNMENT_CENTER: cef_axis_alignment_t = 1;
#[doc = " Child views will be right/bottom-aligned."]
pub const cef_axis_alignment_t_CEF_AXIS_ALIGNMENT_END: cef_axis_alignment_t = 2;
#[doc = " Child views will be stretched to fit."]
pub const cef_axis_alignment_t_CEF_AXIS_ALIGNMENT_STRETCH: cef_axis_alignment_t = 3;
...
pub type cef_axis_alignment_t = ::std::os::raw::c_uint;
...
impl Default for _cef_box_layout_settings_t {
    fn default() -> Self {
        let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
        unsafe {
            ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
...
#[doc = " Front C, LFE"]
pub const cef_channel_layout_t_CEF_CHANNEL_LAYOUT_1_1: cef_channel_layout_t = 34;
#[doc = " Front L, Front R, LFE, Back C"]
pub const cef_channel_layout_t_CEF_CHANNEL_LAYOUT_3_1_BACK: cef_channel_layout_t = 35;
#[doc = " Max value, must always equal the largest entry ever logged."]
pub const cef_channel_layout_t_CEF_CHANNEL_LAYOUT_MAX: cef_channel_layout_t = 35;
...
pub const cef_chrome_page_action_icon_type_t_CEF_CPAIT_MEMORY_SAVER:
...
pub const cef_chrome_page_action_icon_type_t_CEF_CPAIT_QR_CODE_GENERATOR_DEPRECATED:
    cef_chrome_page_action_icon_type_t = 12;
pub const cef_chrome_page_action_icon_type_t_CEF_CPAIT_READER_MODE_DEPRECATED:
...
pub const cef_chrome_page_action_icon_type_t_CEF_CPAIT_SEND_TAB_TO_SELF_DEPRECATED:
...
pub const cef_chrome_page_action_icon_type_t_CEF_CPAIT_PRODUCT_SPECIFICATIONS:
    cef_chrome_page_action_icon_type_t = 28;
pub const cef_chrome_page_action_icon_type_t_CEF_CPAIT_LENS_OVERLAY:
    cef_chrome_page_action_icon_type_t = 29;
pub const cef_chrome_page_action_icon_type_t_CEF_CPAIT_DISCOUNTS:
    cef_chrome_page_action_icon_type_t = 30;
...
pub const cef_permission_request_types_t_CEF_PERMISSION_TYPE_CAPTURED_SURFACE_CONTROL:
...
pub const cef_permission_request_types_t_CEF_PERMISSION_TYPE_HAND_TRACKING:
    cef_permission_request_types_t = 512;
pub const cef_permission_request_types_t_CEF_PERMISSION_TYPE_IDENTITY_PROVIDER:
    cef_permission_request_types_t = 1024;
pub const cef_permission_request_types_t_CEF_PERMISSION_TYPE_IDLE_DETECTION:
    cef_permission_request_types_t = 2048;
...
pub const cef_permission_request_types_t_CEF_PERMISSION_TYPE_KEYBOARD_LOCK:
    cef_permission_request_types_t = 65536;
pub const cef_permission_request_types_t_CEF_PERMISSION_TYPE_POINTER_LOCK:
...
pub const cef_permission_request_types_t_CEF_PERMISSION_TYPE_VR_SESSION:
    cef_permission_request_types_t = 2097152;
pub const cef_permission_request_types_t_CEF_PERMISSION_TYPE_WEB_APP_INSTALLATION:
    cef_permission_request_types_t = 4194304;
pub const cef_permission_request_types_t_CEF_PERMISSION_TYPE_WINDOW_MANAGEMENT:
    cef_permission_request_types_t = 8388608;
pub const cef_permission_request_types_t_CEF_PERMISSION_TYPE_FILE_SYSTEM_ACCESS:
    cef_permission_request_types_t = 16777216;
...
pub const cef_task_type_t_CEF_TASK_TYPE_UNKNOWN: cef_task_type_t = 0;
#[doc = " The main browser process."]
pub const cef_task_type_t_CEF_TASK_TYPE_BROWSER: cef_task_type_t = 1;
#[doc = " A graphics process."]
pub const cef_task_type_t_CEF_TASK_TYPE_GPU: cef_task_type_t = 2;
#[doc = " A Linux zygote process."]
pub const cef_task_type_t_CEF_TASK_TYPE_ZYGOTE: cef_task_type_t = 3;
#[doc = " A browser utility process."]
pub const cef_task_type_t_CEF_TASK_TYPE_UTILITY: cef_task_type_t = 4;
#[doc = " A normal WebContents renderer process."]
pub const cef_task_type_t_CEF_TASK_TYPE_RENDERER: cef_task_type_t = 5;
#[doc = " An extension or app process."]
pub const cef_task_type_t_CEF_TASK_TYPE_EXTENSION: cef_task_type_t = 6;
#[doc = " A browser plugin guest process."]
pub const cef_task_type_t_CEF_TASK_TYPE_GUEST: cef_task_type_t = 7;
#[doc = " A plugin process."]
pub const cef_task_type_t_CEF_TASK_TYPE_PLUGIN: cef_task_type_t = 8;
#[doc = " A sandbox helper process"]
pub const cef_task_type_t_CEF_TASK_TYPE_SANDBOX_HELPER: cef_task_type_t = 9;
#[doc = " A dedicated worker running on the renderer process."]
pub const cef_task_type_t_CEF_TASK_TYPE_DEDICATED_WORKER: cef_task_type_t = 10;
#[doc = " A shared worker running on the renderer process."]
pub const cef_task_type_t_CEF_TASK_TYPE_SHARED_WORKER: cef_task_type_t = 11;
#[doc = " A service worker running on the renderer process."]
pub const cef_task_type_t_CEF_TASK_TYPE_SERVICE_WORKER: cef_task_type_t = 12;
...
pub type cef_task_type_t = ::std::os::raw::c_uint;
...
impl Default for _cef_task_info_t {
    fn default() -> Self {
        let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
        unsafe {
            ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
