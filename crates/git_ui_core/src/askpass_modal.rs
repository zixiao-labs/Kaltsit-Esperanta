            ...
            div()
                ...
                .child(
                    h_flex().gap_2()
                        ...
                        .child(
                            Label::new(ama10_i18n::tr!("You may need to configure git for Github."))
                                .size(LabelSize::Small),
                        )
                        .child(Button::new("learn-more", ama10_i18n::tr!("Learn more")).color(Color::Accent).label_size(LabelSize::Small).on_click(|_, _, cx| {
