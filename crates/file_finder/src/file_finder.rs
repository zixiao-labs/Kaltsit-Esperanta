            ...
            .when(is_project_scan_running && has_search_query, |this| {
                this.child(
                    h_flex()
                        ...
                        .tooltip(Tooltip::text(tr!("Project Scan in Progress…")))
                        .child(
            ...
            h_flex()
                                ...
                                Some(ContextMenu::build(window, cx, {
                                    ...
                                    move |menu, _, _| {
                                        menu.context(focus_handle.clone())
                                            .header(tr!("Filter Options"))
                                            .toggleable_entry(
                                                tr!("Include Ignored Files"),
                ...
                .child(
                    h_flex()
                        ...
                        .child(
                            Button::new("open-without-dismiss", tr!("Keep Open"))
                                .key_binding(
                                    KeyBinding::for_action_in(
                                        &OpenWithoutDismiss,
                                        &focus_handle,
                        ...
                        .child(
                            Button::new("open-selection", tr!("Open"))
                                .key_binding(
